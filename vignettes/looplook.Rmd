...
<div style="margin: 30px auto; display: table; clear: both;">

```{r comparison-table, echo=FALSE, message=FALSE, warning=FALSE}
if (!requireNamespace("kableExtra", quietly = TRUE)) {
  knitr::kable(comp, format = "html", escape = FALSE)
} else {
  library(kableExtra)
...
knitr::kable(
  ...
  row_spec(0, bold = TRUE, color = "black", background = "#F8F9FA", extra_css = "border: 1px solid #DDDDDD;") %>%
  column_spec(1:7, extra_css = "border: 1px solid #DDDDDD; padding: 8px;")
}
```
